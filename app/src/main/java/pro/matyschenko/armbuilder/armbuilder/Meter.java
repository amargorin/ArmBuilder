...
public class Meter extends View {
    ...
    private void applyAttrs(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Meter, 0, 0);
        totalNicks = a.getInt(R.styleable.Meter_totalNicks, totalNicks);
        degreesPerNick = 360.0f / totalNicks;
        valuePerNick = a.getFloat(R.styleable.Meter_valuePerNick, valuePerNick);
        majorNickInterval = a.getInt(R.styleable.Meter_majorNickInterval, 10);
        minValue = a.getFloat(R.styleable.Meter_minValue, minValue);
        maxValue = a.getFloat(R.styleable.Meter_maxValue, maxValue);
        intScale = a.getBoolean(R.styleable.Meter_intScale, intScale);
        initialValue = a.getFloat(R.styleable.Meter_initialValue, initialValue);
        requestedLabelTextSize = a.getFloat(R.styleable.Meter_labelTextSize, requestedLabelTextSize);
        faceColor = a.getColor(R.styleable.Meter_faceColor, Color.argb(0xff, 0xff, 0xff, 0xff));
        circleColor = a.getColor(R.styleable.Meter_circleColor, Color.argb(0xff, 0xff, 0xff, 0xff));
        scaleColor = a.getColor(R.styleable.Meter_scaleColor, 0x9f004d0f);
        needleColor = a.getColor(R.styleable.Meter_needleColor, Color.RED);
        needleShadow = a.getBoolean(R.styleable.Meter_needleShadow, needleShadow);
        requestedTextSize = a.getFloat(R.styleable.Meter_textSize, requestedTextSize);
        upperText = a.getString(R.styleable.Meter_upperText) == null ? upperText : fromHtml(a.getString(R.styleable.Meter_upperText)).toString();
        lowerText = a.getString(R.styleable.Meter_lowerText) == null ? lowerText : fromHtml(a.getString(R.styleable.Meter_lowerText)).toString();
        requestedUpperTextSize = a.getFloat(R.styleable.Meter_upperTextSize, 0);
        requestedLowerTextSize = a.getFloat(R.styleable.Meter_lowerTextSize, 0);
        a.recycle();
    ...
    private void initPaint() {
        ...
        rimPaint.setColor(circleColor);
//        rimPaint.setStyle(Paint.Style.FILL_AND_STROKE);
//        rimPaint.setStrokeWidth(0.2f);

        rimCirclePaint = new Paint();
        rimCirclePaint.setAntiAlias(true);
        rimCirclePaint.setStyle(Paint.Style.STROKE);
        //rimCirclePaint.setColor(Color.argb(0x4f, 0x33, 0x36, 0x33));
        rimCirclePaint.setColor(circleColor);
